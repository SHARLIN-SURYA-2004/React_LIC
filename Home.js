    ...
    <main>
      ...
      <section id="home" className="hero-section">
        ...
        <div className="hero-content">
          <h2>Welcome to Our Life Insurance Policies</h2>
      ...
      <section id="services" className="services-section">
        ...
        <div className="cards-container">
          <Link to="/termlifecondition" className="card">
          ...
          <Link to="/wholelifecondition" className="card">
          ...
          <Link to="/universallifecondition" className="card">
          ...
          <Link to="/variablelifecondition" className="card">
          ...
          <Link to="/variableuniversallifecondition" className="card">
          ...
          <Link to="/indexeduniversallifecondition" className="card">
          ...
          <Link to="/guaranteedissuelifecondition" className="card">
          ...
          <Link to="/simplifiedissuelifecondition" className="card">
          ...
          <Link to="/grouplifecondition" className="card">
          ...
          <Link to="/finalexpensecondition" className="card">
